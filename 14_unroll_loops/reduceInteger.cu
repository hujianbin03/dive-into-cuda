...
int main(int argc, char **argv)
{
    ...
    printf("gpu Unrolling2  花费 %lf ms gpu_sum: %d <<<grid %d block %d>>>\n", iElaps, gpu_sum, grid.x/2, block.x);
    ...
    printf("gpu Unrolling4  花费 %lf ms gpu_sum: %d <<<grid %d  block %d>>>\n", iElaps, gpu_sum, grid.x/4, block.x);
    ...
    printf("gpu Unrolling8  花费 %lf ms gpu_sum: %d <<<grid %d  block %d>>>\n", iElaps, gpu_sum, grid.x/8, block.x);
